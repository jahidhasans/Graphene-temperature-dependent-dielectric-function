...
4. [Workflow Overview](#4-workflow-overview)
   - [Step 1 — Ground-state DFT for initial guess (QE)](#step-1--ground-state-dft-qe)
   - [Step 2 — Harmonic Force Constants via DFPT (for ground state) or SDM/ASDM (for finite-temperature effects) (QE)](#step-2--harmonic-force-constants-qe)
